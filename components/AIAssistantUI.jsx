...
export default function AIAssistantUI() {
  ...
  async function sendMessage(convId, content) {
    ...
    setConversations((prev) =>
      prev.map((c) => {
        ...
        return {
          ...
          title: c.title === "New Chat" ? content.slice(0, 50) + (content.length > 50 ? "..." : "") : c.title,
        }
      }),
    )
    ...
    try {
      ...
      const aiFormattedMessages = allMessages.map((msg) => ({
        role: msg.role,
        content: msg.content,
      }))
      ...
      // Clear thinking state and add AI response
      setIsThinking(false)
      ...
      const asstMsg = {
        ...
        role: "assistant",
        content: aiResponse || "I received your message and I'm ready to help!",
      ...
      // Clear thinking state and show fallback response
      setIsThinking(false)
      setThinkingConvId(null)
