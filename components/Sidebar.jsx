    ...
    <>
      ...
      <AnimatePresence>
        {(open || (typeof window !== "undefined" && window.innerWidth >= 768)) && (
          <motion.aside
            key="sidebar"
            initial={{ x: typeof window !== "undefined" && window.innerWidth < 768 ? -340 : 0 }}
            animate={{ x: open || (typeof window !== "undefined" && window.innerWidth >= 768) ? 0 : -340 }}
            exit={{ x: -340 }}
            transition={{ type: "spring", stiffness: 260, damping: 28 }}
            className={cls(
          ...
          >
            ...
            <div className="mt-auto border-t border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              ...
              <div className="mt-2 flex items-center gap-2 rounded-xl bg-zinc-50 p-2 dark:bg-zinc-800/60">
                <div className="grid h-8 w-8 place-items-center rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 text-xs font-bold text-white">
                  {selectedModel === "groq" ? "🚀" : selectedModel === "grok" ? "🤖" : "🧠"}
                </div>
                <div className="min-w-0">
                  ...
                  <div className="truncate text-xs text-zinc-500 dark:text-zinc-400">
                    {selectedModel === "groq" || selectedModel === "grok" ? "Connected" : "Available"}
                  </div>
                </div>
              </div>
            </div>
